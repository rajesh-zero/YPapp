<%@ Page Title="" Language="C#" MasterPageFile="~/Home.master" AutoEventWireup="true" CodeFile="ChooseChannelForDB.aspx.cs" Inherits="ChooseChannelForDB" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <div class="form-inline">
    <div class="form-group">
      <label style="font-size:25px">Choose Channel you want to view Dashboard : </label>
