<%@ Page Title="" Language="C#" MasterPageFile="~/User/Channel/Channel.master" AutoEventWireup="true" CodeFile="EditDraft.aspx.cs" Inherits="User_Channel_EditDraft" %>
                ...
                <div class="row" style="padding-top: 20px">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            Edit Draft Article : <asp:Label ID="lblName" runat="server" Text="" ForeColor="#000099"></asp:Label>
                        </div>
                    </div>
                </div>
...
&nbsp;<asp:RequiredFieldValidator ID="RFVpreview" runat="server" ControlToValidate="txtHeading" Display="Dynamic" ErrorMessage="Heading is compulsory" Font-Size="Small" ForeColor="Red" ValidationGroup="ValPreview"></asp:RequiredFieldValidator>
                            ...
                            <div class="col-md-3" style="text-align: center">
                                <asp:Button ID="btnDelete" class="btn btn-warning" runat="server" Text="Delete" CausesValidation="False" OnClick="btnDelete_Click" />
                                &nbsp;
                        ...
                        <div class="row  col-xs-12">
                            ...
                            <div class="col-md-5">
                                ...
                                <asp:Image ID="Image1" style="width:160px;height:90px" runat="server" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="col-md-2 col-md-offset-10" style="text-align: center">
                                <asp:Button ID="btnUpdateDraft" class="btn btn-danger btn-sm" runat="server" Text="Update Draft" OnClick="btnUpdateDraft_Click" ValidationGroup="ValDraft" />
                            </div>
                        </div>
                    </div>
                </div>
