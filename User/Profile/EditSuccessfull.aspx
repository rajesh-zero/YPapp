<%@ Page Title="" Language="C#" MasterPageFile="~/User/Profile/Profile.master" AutoEventWireup="true" CodeFile="EditSuccessfull.aspx.cs" Inherits="User_Profile_EditSuccessfull" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     <div id="trueSuccess" class="row" runat="server"  style="border-style: solid; border-color: #dddddd; border-width: thin; border-radius: 5px;">
        <div style="text-align:center;padding:75px;" >
            ...
            <h2 style="color: cadetblue">Profile Updated Successfully</h2>
            <br />
